function [x,fval,exitflag,output,grad,rel_err_s_plot]=fminlbfgs_errplot(funfcn,x_init,optim,s_true)
...
while(true)
    ...
    rel_err_s = norm(data.xInitial(:) - s_true(:)) / norm_s_true;
    rel_err_s_plot = [rel_err_s_plot; rel_err_s];
end
